...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <br>
            <br>
            <a href="ProductoControlador?action=add" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Nuevo</a>
            <br>
            <br>
            <table class="table table-striped">
                ...
                <c:forEach var="item" items="${producto}">
                    <tr>
                        ...
                        <td><a href="ProductoControlador?action=delete&id=${item.id}" onclick="return(confirm('Esta Usted Seguro?'))">
