...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <br>
            <br>
            <a href="UsuarioControlador?action=add" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Nuevo</a>
            <br>
            <br>
            <table class="table table-striped">
                ...
                <c:forEach var="item" items="${usuario}">
                    <tr>
                        ...
                        <td><a href="UsuarioControlador?action=delete&id=${item.id}" onclick="return(confirm('Esta Usted Seguro?'))">
